...
parser.add_argument("-q", "--quick", dest="quick", help="if the sequence alignment takes over 0.01 seconds, stop aligning and assume the sequences are different enough! This doesn't guarantee the database will have your exact sequence ID cutoffs, but in practice typically highly different sequences compared to each other take a long time to compute, and this option speeds up the dataset generation significantly.")
